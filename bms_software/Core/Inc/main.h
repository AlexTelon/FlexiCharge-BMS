...
#define ADC_cell1_voltage_Pin GPIO_PIN_0
#define ADC_cell1_voltage_GPIO_Port GPIOA
#define ADC_cell2_voltage_Pin GPIO_PIN_1
#define ADC_cell2_voltage_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define ADC_pre_voltage_Pin GPIO_PIN_4
#define ADC_pre_voltage_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define ADC_post_voltage_Pin GPIO_PIN_6
#define ADC_post_voltage_GPIO_Port GPIOA
